# UGC video prompt formula — Seedance 2
...
|----------|---------|-------|
| `DURATION` | 15 seconds, 10 seconds | 15s is the Seedance 2 maximum. Use 10s for punchier clips with less dialogue. |
...
- [ ] **Word count** — prompt is between 100–260 words (Seedance 2 sweet spot)
