# Product hero — Seedance 2

**Use when:** You need a dramatic, no-person product showcase where the product itself is the star. The product is shot like a movie poster — moody lighting, colored backdrop, and elemental interaction (water splashing, ice, mist, dust, sparks, smoke). Works best for beverages, supplements, cans, bottles, cosmetics, tech gadgets, or any product with strong visual packaging.

**Model guide:** Read [seedance-2.md](seedance-2.md) first for platform rules, API parameters, and the adaptation checklist.

## What defines this style

There is no person in this video. The product is the only subject, and the entire visual language is built around making it look larger than life.

1. **The product is the hero.** Every shot is framed around the product — extreme close-ups of the label, dramatic angles looking up at it, wide hero compositions showing multiple variants. The camera treats the product the way a portrait photographer treats a face.

2. **Elemental interaction creates the action.** Since there's no person doing things, the visual energy comes from the product's environment — water splashing against the can, rain falling on the surface, condensation beading up, ice cracking, mist swirling. The product itself stays mostly static while the world around it moves.

3. **Dramatic lighting and color set the mood.** The background is a single deep color (blue, black, dark teal, amber), the product is spot-lit, and the contrast is high. Shadows and highlights are deliberately dramatic — they give the product weight and presence.
...
| `CAMERA_STYLE` | slow-motion macro photography, dramatic product cinematography, high-speed product photography | Describes the shooting approach |
...
| `ELEMENTAL_EFFECT_1` | water splashing dramatically around the product, rain falling onto the can, mist swirling at the base, ice cracking and shifting | PRIMARY motion in the video |
...
3-4 shots that escalate in drama. Sequence typically moves from tight/tactile to wide/heroic.
...
**Camera:** High-end product photography quality. Tack-sharp focus on the label. Slow-motion capture on splash/water effects. Very smooth camera movement, no shake.
...
- [ ] **15 seconds** — single Seedance 2 clip
...
- [ ] **3-4 shots that escalate** — macro → interaction → dramatic angle → hero composition
- [ ] **Camera movement is slow and deliberate** — no fast cuts, no handheld
- [ ] **Tagline overlay included** — short, punchy, 4-8 words
