# Premium Product Reveal — Seedance 2
...
|----------|---------|-------|
| `DURATION` | 15 seconds | Seedance 2 maximum. Use full duration for this style. |
...
- [ ] **15 seconds** — single Seedance 2 clip (max duration)
